...
# classifier = Classifier("Models/Testing/A-Z (Except Q & Z) (500!70)/keras_model.h5", "Models/Testing/A-Z (Except Q & Z) (500!70)/labels.txt")
# classifier = Classifier("Models/A-C (500!70)/keras_model.h5", "Models/A-C (500!70)/labels.txt")
# classifier = Classifier("Models/A-C (1000!100)/keras_model.h5", "Models/A-C (1000!100)/labels.txt")
# classifier = Classifier("Models/A-Z (Except Q & Z) (1000!100)/keras_model.h5", "Models/A-Z (Except Q & Z) (1000!100)/labels.txt")
